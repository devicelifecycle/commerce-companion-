...
serve(async (req) => {
  ...
  try {
    ...
    const knownCodes = new Set([
      // Assets
      '1000','1001','1050','1051','1100','1101','1110','1111','1200','1201',
      // Liabilities
      '2000','2001','2010','2011','2050','2051','2100','2101','2200','2201','2300','2301',
      // Equity
      '3000','3001','3100','3101','3200','3201',
      // Revenue (incl. Shipping Revenue 4002/4102/4103)
      '4000','4002','4100','4101','4102','4103','4200','4201','4300','4400','4401',
      // COGS
      '5000','5001',
      // Operating Expenses (base + per-company variants)
      '6000','6001','6100','6101',
      '6200','6201','6202','6300','6301','6302','6400','6401','6402','6500','6501','6502',
      '6600','6602','6700','6702','6800','6802','6900','6902',
      // Retired but historically present
      '6950','6951',
      // Other expenses
      '7000','7001','7002','7100','7101','7102','7200','7201',
      // Tax paid
      '8000','8001','8100','8101',
    ]);
