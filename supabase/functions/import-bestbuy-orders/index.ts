  ...
  try {
    ...
    if (orders.length > 0) {
      ...
      const bbKnownPaths = [
        ...
        'customer.billing_address', 'customer.billing_address.city',
        'customer.billing_address.civility', 'customer.billing_address.company',
        'customer.billing_address.company_2', 'customer.billing_address.country',
        'customer.billing_address.country_iso_code', 'customer.billing_address.firstname',
        'customer.billing_address.lastname', 'customer.billing_address.phone',
        'customer.billing_address.phone_secondary', 'customer.billing_address.state',
        'customer.billing_address.street_1', 'customer.billing_address.street_2',
        'customer.billing_address.zip_code',
        'customer.shipping_address', 'customer.shipping_address.city',
        'customer.shipping_address.civility', 'customer.shipping_address.company',
        'customer.shipping_address.company_2', 'customer.shipping_address.country',
        'customer.shipping_address.country_iso_code', 'customer.shipping_address.firstname',
        'customer.shipping_address.lastname', 'customer.shipping_address.phone',
        'customer.shipping_address.phone_secondary', 'customer.shipping_address.state',
        'customer.shipping_address.street_1', 'customer.shipping_address.street_2',
        'customer.shipping_address.zip_code', 'customer.shipping_address.additional_info',
        ...
        // Standard Mirakl fields (non-critical)
        'acceptance_decision_date', 'can_shop_ship', 'currency_iso_code',
        'customer_debited_date', 'customer_notification_email', 'delivery_date',
        'has_customer_message', 'has_incident', 'has_invoice',
        'leadtime_to_ship', 'order_additional_fields', 'order_tax_mode',
        'paymentType', 'payment_duration', 'promotions',
        'quote_id', 'shipping_carrier_code', 'shipping_company',
        'shipping_deadline', 'shipping_tracking', 'shipping_tracking_url',
        'shipping_type_code', 'shipping_type_label', 'transaction_date',
        'transaction_number',
      ];
