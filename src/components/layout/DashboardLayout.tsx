    ...
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-background">
        ...
        <main className="flex-1 overflow-auto">
          <header className="sticky top-0 z-10 h-12 flex items-center gap-3 border-b border-border/60 bg-background/95 backdrop-blur-xl px-4">
            <SidebarTrigger className="-ml-1 hover:bg-muted hover:text-foreground transition-colors rounded-md h-8 w-8" />
